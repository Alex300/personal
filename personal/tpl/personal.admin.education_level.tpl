<!-- BEGIN: MAIN -->
<!-- IF {PAGE_TITLE} -->
<h2 class="tags"><img src="{PHP.cfg.modules_dir}/{PHP.env.ext}/tpl/images/education.png" style="vertical-align: middle;" /> {PAGE_TITLE}</h2>
<!-- ENDIF -->

<div class="block">
    <form method="post" action="{LIST_FORM_URL}" class="ajax" id="editEducation" name="editEducation">
...
<div class="block">
    <h3>{PHP.L.Add}:</h3>
    <form enctype="multipart/form-data" class="ajax" method="post" action="{ADDFORM_URL}" id="addEducation" name="addEducation">
